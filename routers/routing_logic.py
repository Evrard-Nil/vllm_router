...
from stats.engine_stats import EngineStats
from stats.request_stats import RequestStats
...
class PrefixAwareRouter(RoutingInterface):
    ...
    This router now includes LRU eviction to prevent OOM issues.
    """
...
def initialize_routing_logic(
    ...
    if routing_logic == RoutingLogic.ROUND_ROBIN:
        ...
        return PrefixAwareRouter(
            ...
            eviction_batch_size=kwargs.get("eviction_batch_size", 100),
